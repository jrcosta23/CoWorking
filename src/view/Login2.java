...
public class Login2 extends JDialog {
	...
	public Login2() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(Login2.class.getResource("/img/logo.png")));
		...
		imgDatabase.setIcon(new ImageIcon(Login2.class.getResource("/img/databaseOff.png")));
	...
	private void statusConexaoBanco() {
		try {
			...
			if (conexaoBanco == null) {
				...
				imgDatabase.setIcon(new ImageIcon(Login2.class.getResource("/img/databaseOn.png")));
			}
			conexaoBanco.close();
		} catch (Exception e) {
