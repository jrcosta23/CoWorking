	...
	private void adicionarReserva() {
		...
		// Validação do fim da reserva
			...
			try {
				...
				SimpleDateFormat formatadorReserva1 = new SimpleDateFormat("yyyyMMdd");
				String dataInicioReservaFormatada = formatadorReserva1.format(inputInicioReserva.getDate());
